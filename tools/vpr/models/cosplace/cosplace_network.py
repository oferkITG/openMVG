...
from tools.vpr.models.cosplace.ResNet50 import resnet50
from tools.vpr.models.cosplace.layers import Flatten, L2Norm, GeM
...
class GeoLocalizationNet(nn.Module):
    def __init__(self, backbone : str, fc_output_dim : int, train_all_layers : bool = False, weights: str = None):
