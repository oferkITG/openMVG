...
from tools.features.base import KeypointData
...
class SuperPoint(nn.Module):
    ...
    def __init__(self, config, verbose: bool = False):
        ...
        path = Path(__file__).parent.parent.parent / 'assets/weights/superpoint_v1.pth'
    ...
    @torch.no_grad
    def detectAndCompute(self, image: np.array, device: str ='cpu', mask=None) -> KeypointData:
